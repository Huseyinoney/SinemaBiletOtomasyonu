...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 16 May 2022, 12:47:15
...
ALTER TABLE `bilet`
  ...
  ADD KEY `FilmAdi` (`FilmAdi`,`UserName`),
...
--
ALTER TABLE `bilet`
  ADD CONSTRAINT `bilet_ibfk_1` FOREIGN KEY (`OdemeTarih`) REFERENCES `odeme` (`OdemeTarih`),
  ADD CONSTRAINT `bilet_ibfk_2` FOREIGN KEY (`UserName`) REFERENCES `müsteri` (`UserName`),
  ADD CONSTRAINT `bilet_ibfk_3` FOREIGN KEY (`FilmAdi`) REFERENCES `film` (`FilmAdi`);
